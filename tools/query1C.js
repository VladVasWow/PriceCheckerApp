...
ВЫБРАТЬ РАЗРЕШЕННЫЕ ПЕРВЫЕ 1
        ...
        ИЗ
            Справочник.Номенклатура КАК СправочникНоменклатура
                ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЦеныКомпании.СрезПоследних(&currentDate, ТипЦен = ВЫРАЗИТЬ(&market КАК Справочник.Магазины).ТипЦенРозничнойТорговли) КАК ЦеныКомпанииСрезПоследних
...
export const queryProductByScanCode1c = `
        ВЫБРАТЬ РАЗРЕШЕННЫЕ ПЕРВЫЕ 1
            ...
            ЕСТЬNULL(ЦеныКомпанииСрезПоследних.Цена, 0) КАК price,
            ЦеныКомпанииСрезПоследних.Валюта.НаименованиеКраткое КАК currency,
        ...
        ИЗ
            ...
            И туМаркетинговаяКампанияТовары.Ссылка.Магазин = &market
...
export const queryAdvertisement = `
        ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ ПЕРВЫЕ 2000
        ...
        ИЗ
            Документ.туМаркетинговаяКампания.Товары КАК туМаркетинговаяКампанияТовары
                ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЦеныКомпании.СрезПоследних(, ТипЦен = ВЫРАЗИТЬ(&market КАК Справочник.Магазины).ТипЦенРозничнойТорговли) КАК ЦеныКомпанииСрезПоследних
